...
import com.trikersdev.secret.adapter.CommentListAdapter;
...
public class ViewItemFragment extends Fragment implements Constants, SwipeRefreshLayout.OnRefreshListener, CommentInterface, TagClick {
    ...
    TextView mItemCity, mItemCountry, mItemTimeAgo, mItemLikesCount, mItemCommentsCount, mItemCategory;
    ResizableImageView mItemImg;
    EmojiconTextView mItemPost;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mItemPost = (EmojiconTextView) mListViewHeader.findViewById(R.id.itemPost);
    ...
    public void updateItem() {
        ...
        mItemCategory.setText(getCategory(item.getCategory()));
    ...
    private String getCategory(int category) {
        ...
        return getActivity().getResources().getStringArray(R.array.navSpinnerItems)[category];
    }
...
//                                Toast.makeText(ViewItemActivity.this, response.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void onCommentCreateChat(final int position) {

        final Comment comment = commentsList.get(position);

        final long userId = comment.getFromUserId();
