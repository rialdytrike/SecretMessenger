...
public class PostActionDialog extends DialogFragment implements Constants {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        arrayAdapter.add(getString(R.string.action_follow) + "/" + getString(R.string.action_unfollow));
        arrayAdapter.add(getString(R.string.action_create_chat));
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which) {
                    ...
                    case 1: {
                        ...
                        alertPositiveListener.onPostFollow(position);
                    ...
                    case 2: {
                        ...
                        alertPositiveListener.onPostCreateChat(position);
