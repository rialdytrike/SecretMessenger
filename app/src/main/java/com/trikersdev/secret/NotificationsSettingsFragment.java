...
public class NotificationsSettingsFragment extends PreferenceFragment implements Constants {
    ...
    private CheckBoxPreference mAllowLikesGCM, mAllowCommentsGCM, mAllowMessagesGCM, mAllowCommentReplyGCM;

    private ProgressDialog pDialog;

    int mAllowLikes, mAllowComments, mAllowMessages, mAllowCommentReply;
